...
- **ADR**: [0009-confirm-workflow-preview-vs-import-split](../decisions/0009-confirm-workflow-preview-vs-import-split.md)
- **Status**: ✅ 已实施
...
- `0009-confirm-workflow-preview-vs-import-split.md`：保存与入库解耦的接口边界
