...
|------|-------------|--------|---------|--------------|-----------|
| REQ-20260907-103627 发布 fnOS 0.3.34 正式版 | 2026-09-07 | `352336c` / tag `v0.3.34` | 将真机验收通过的 0.3.34 发布为公开 GitHub 正式 Latest Release；同时提供 FPK 与 SHA-256；[发布记录](../_archive/2026-09-07-fnos-0-3-34-github-release/2026-09-07-release-fnos-0-3-34.md)、[Release](https://github.com/wae2855/nas_media_manage/releases/tag/v0.3.34) | Release `draft=false`、`prerelease=false`、Latest 指向 v0.3.34；标签精确指向 `352336c6cd62e6c5187bbd52e22e379371c49366`；匿名回下载 11,827,409 字节，SHA-256 `67b6eebb6464653c371cd24418ccfb70cd971cecb010d6a057125ffbfad3ee2b`，包内容与本地逐字节一致，版本和结构校验 PASS | v0.3.32 保留为历史 prerelease；0.3.33 不发布 |
| REQ-20260905-200250 发布 fnOS 0.3.32 GitHub Release | 2026-09-07 | `a8e56c3` / tag `v0.3.32` | 0.3.32 候选版发布和公开回下载验证已完成；后续缺陷在 0.3.34 修复并通过真机验收，因此正式发布路径由 v0.3.34 接替；[历史发布记录](../_archive/2026-09-05-fnos-0-3-32-github-release/2026-09-05-chore-publish-fnos-0-3-32-release-plan.md) | v0.3.32 继续保持 prerelease，不再作为待转正版本；正式 Latest 为 v0.3.34 | 保留历史候选资产用于追溯，不删除、不改写 |
| REQ-20260905-231945 来源清理文件覆盖与真实链路补测 | 2026-09-07 | `6a3fe62` | 修复北海鲸梦类历史重复任务阻挡来源处理，完整文件包 SHA-256 证明后才解除阻挡；同步整组来源状态，并加固保留/重试竞争、批量重试、归位任务、字幕缺失和同剧部分失败反馈；[验收记录](../testing/fnos-source-cleanup-hardening-2026-09-05.md) | DEV 1214/1214、专项 106/106、发布专项 29/29 PASS；0.3.34 FPK SHA-256 `67b6eebb6464653c371cd24418ccfb70cd971cecb010d6a057125ffbfad3ee2b`；用户确认 `FNOS_UAT PASS` | 已登记为最近 fnOS 验收正常版本，随 v0.3.34 正式发布 |
