...
|------|--------------|--------|-------|--------------|--------------------------|
| Feature-first architecture and documentation restructure | 2026-06-02 | `42c88b9`, `cb1d876` + pending final commit | Code structure, docs structure, archive policy, lifecycle workflow, test archive, feature public APIs, product/API ownership docs | `python3 -m pytest tests/` -> 155 passed; `compileall`; `git diff --check` | Confirm new architecture/docs direction after implementation |
