...
- `SourceCleaner`: `media_importer/domains/source_cleaning/cleaner.py`
- 清理记录 repo 入口: `media_importer/domains/source_cleaning/records.py`
...
- `tests/test_domain_source_cleaning_compatibility.py`
