...
| `media_importer/scraper/` | LLM 刮削、Provider、置信度、维度映射；待迁移到 feature | [features/scraping.md](features/scraping.md) | [architecture/scraping.md](architecture/scraping.md) | `tests/test_confidence_engine.py` |
| `media_importer/scraper/providers/` | 元数据源 Provider 抽象与 TMDB 实现；待迁移到 feature | [features/providers.md](features/providers.md) | [architecture/scraping.md](architecture/scraping.md) | Provider/API 测试 |
