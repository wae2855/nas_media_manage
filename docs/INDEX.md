...
| `media_importer/core/` | 配置、任务、DB、日志、指标、安全基础设施 | [features/configuration.md](features/configuration.md), [features/tasks.md](features/tasks.md) | [architecture/configuration.md](architecture/configuration.md), [architecture/task-lifecycle.md](architecture/task-lifecycle.md) | core 单测 |
