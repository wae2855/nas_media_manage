...
| `media_importer/pipeline/` | 入库流程旧兼容入口；新实现和新入口优先使用 `domains/import_flow/` | [modules/pipeline.md](modules/pipeline.md) | [architecture/import-pipeline.md](architecture/import-pipeline.md) | `tests/test_full_flow.py`, `tests/test_domain_entrypoints.py` |
