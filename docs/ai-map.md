...
| 修改刮削逻辑 | [features/scraping.md](features/scraping.md), [architecture/scraping.md](architecture/scraping.md) | `scraper/metadata_scraper.py`, `scraper/llm_scraper.py`, `scraper/confidence_engine.py` | confidence/scrape 测试 | scraping 文档 |
| 新增 Provider | [features/providers.md](features/providers.md) | `scraper/providers/` | Provider/API 测试 | ADR 如影响架构 |
