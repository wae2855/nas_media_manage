...
| 修改刮削逻辑 | [features/scraping.md](features/scraping.md), [architecture/scraping.md](architecture/scraping.md) | `features/scraping/metadata_scraper.py`, `features/scraping/confidence_engine.py`, `features/scraping/dimension_manager.py`, `scraper/llm_scraper.py` | confidence/scrape 测试 | scraping 文档 |
