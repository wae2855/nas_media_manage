...
| 修改刮削逻辑 | [features/scraping.md](features/scraping.md), [architecture/scraping.md](architecture/scraping.md) | `features/scraping/metadata_scraper.py`, `features/scraping/`, `scraper/llm_scraper.py`, `scraper/confidence_engine.py` | confidence/scrape 测试 | scraping 文档 |
