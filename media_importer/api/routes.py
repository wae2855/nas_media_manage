...
API_ROUTES = [
    ...
    _route("GET", "/api/dimensions/{dim_name}/mappings/{provider_type}", "_dimension_mapping_get"),
    ...
    _route("GET", "/api/providers/{provider_type}/dimension-capabilities", "_provider_dimension_capabilities"),
    ...
    _route("POST", "/api/tasks/{task_id}/dispose", "_task_dispose"),
    ...
    _route("POST", "/api/dimensions/{dim_name}/mappings/{provider_type}/preview", "_dimension_mapping_preview"),
    ...
    _route("PUT", "/api/dimensions/{dim_name}/mappings/{provider_type}", "_dimension_mapping_update"),
