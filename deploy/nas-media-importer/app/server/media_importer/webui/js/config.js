...
async function loadConfig() {
    try {
        ...
        document.getElementById('cfg-tmdb_confidence_threshold').value = tmdb.confidence_threshold || 0.6;
        ...
        if (result.data && result.data.prompts) {
            ...
            document.getElementById('prompt-tmdb').value = prompts.tmdb_system_prompt || '';
        }
    } catch (e) {
    ...
    var data = {
        metadata: {
            tmdb: {
                ...
                confidence_threshold: parseFloat(document.getElementById('cfg-tmdb_confidence_threshold').value) || 0.6
            }
        }
    };
